...
#${RESTIC} -r ${BACKUP_LOCATION} restore latest --target / --include "/home/joe/.mozilla"  # Unlock repo

${RESTIC} -r ${BACKUP_LOCATION} restore "${ID}" --target / --include "/home/joe/.var/app/org.mozilla.firefox/.mozilla"  # Unlock repo

#${RESTIC} -r ${BACKUP_LOCATION} restore 68a67dc0 --target / --include "/home/joe/.config/vivaldi"  # Unlock repo

#${RESTIC} -r ${BACKUP_LOCATION} restore b03b2c9f --target "/"  --include "/home/joe/todo.md"  # Unlock repo

#${RESTIC} -r ${BACKUP_LOCATION} restore latest --target "/"  --include "/home/joe/todo.md"  # Unlock repo
